 ...
 *
 * @description If the email domain of the user's email is "mod.socialsphere.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.socialsphere.com" ? "moderator" : "general";
