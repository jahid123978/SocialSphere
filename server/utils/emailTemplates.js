...
<div style="max-width: 600px; margin: auto; background-color: #f4f4f4; padding: 20px; border-radius: 10px; box-shadow: 0 2px 4px rgb(104, 182, 255);">
  <div style="background-color: #ffffff; padding: 20px; border-radius: 10px;">
    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold text-primary-100 font-inter italic">
  SocialSphere
</h1>
    <p style="font-size: 18px; margin-bottom: 20px; text-align: center; color: #4b5563; font-weight: bold;">Welcome to SocialSphere, ${name}!</p>
